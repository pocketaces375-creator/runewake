...
- Starting hand: **4 cards**. The player going second draws **6** (the "Second Delver" compensation).
...
- **[RESOLVED] First-player advantage compensation** — The second player (P1) now draws 6 cards instead of 5. Confirmed by mirror-mismatch study.
