...
- [ ] TASK-BORDER-FIX-1 — REOPENING TASK-BORDER-1. It is marked [x] but did not pass. I inspected commit 479e2e9 on origin directly: the code landed (RootBoundBorder.cs, 11 files, 710 tests green — that part is real), but the committed capture does not show a passing result and one acceptance claim is false. Do NOT re-mark BORDER-1; fix the three defects below.
