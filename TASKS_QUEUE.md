...
- [ ] TASK-TITLE-LAYOUT-1 — Fix the title screen: the campaign panel is pinned off-centre, the menu buttons overlap each other, and Duel Arena runs off the bottom of the screen. All of it is in client/scripts/Main.cs. Do the steps below IN ORDER.
