...
- [ ] TASK-BORDER-SLICE-1 — Cut the border slices at the 7% band, ship the gold keyline, and gate all of it with numbers. Work in tools/gen_rootbound_border.py and one new file tools/border_check.py. Do the seven steps below IN ORDER.
