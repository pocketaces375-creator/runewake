...
- [ ] TASK-DECKFILTER-1 — The strata filter row at the top of Deck Forge (ALL / VERDANT / EMBER / TIDE / HOLLOW / DAWN) is visually broken and hard to hit: the colored strata swatch sits misaligned against its label, and the tap targets are too small to reliably hit on a phone.
