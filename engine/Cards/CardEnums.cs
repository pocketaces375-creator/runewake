...
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum Duration { PERMANENT, THIS_TURN, NEXT_TURN, WHILE_PRESENT, WHILE_ATTACKING, UNTIL_YOUR_NEXT_TURN }
...
public enum Trigger
{
    ...
    ON_RELIC_IDENTIFY, ON_ALLY_DEATH, ON_ALLY_ATTACKED, ON_LANE_VACATED,
...
public enum Scope
{
    ...
    PLAYER_SELF, PLAYER_ENEMY, LANE, NONE, SELF_ARTIFACT
}
...
public enum ConditionOp
{
    ...
    FRIENDLY, ENEMY, ENEMY_ATTACKS_YOUR_CHARACTER,
    FRIENDLY_ON_YOUR_TURN, AND
}
