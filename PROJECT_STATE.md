...
PHASE 7 STATUS: All feature tickets complete. Final agent item: smoke test script.

REMAINING AGENT ITEMS:
  - [ACTIVE] Write, run, and commit client/smoke_test.sh — exported Linux build starts without crashing, pixel validation passes
...
REMAINING HUMAN-ACTION ITEMS:
  ...
  P7-H2 — TestFlight (iOS) + Play Store internal testing (Android)
